...
const InfoSection = () => {
  return (
    <div className="flex w-full justify-center px-4 pb-10">
      ...
      <Link
        href="/#moto"
        className="absolute top-5/8 right-1/16 hidden h-16 w-16 -translate-y-1/2 items-center justify-center rounded-full border-[0.5px] border-white bg-white/15 backdrop-blur-lg xl:flex"
      >
