...
const CarsGrid = () => {
  return (
    <div className="grid h-auto grid-cols-1 gap-5 pb-3 lg:h-[76rem] lg:grid-cols-3 lg:grid-rows-3 lg:gap-x-1.5 lg:gap-y-4">
      {galleryData.map((item, index) => (
        <motion.div key={index} whileHover={{ scale:1.1, zIndex:70}} className="relative">
          <div
            key={index}
